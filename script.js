const STORAGE_KEY = "stalkernet_pda_v32_archive_locations";
...
// v3.2 Archive expansion: Factions + Mutants + Anomalies + Artifacts + Locations
const LOCATION_ARCHIVE_ENTRIES = [{"title": "Cordon", "category": "Locations", "value": "Surface location", "base": "Southern rookie territory", "relations": "Surface map archive entry.", "text": "Rookie territory, southern roads, patrol routes and early contracts. It is often treated as the first real test of a stalker's life in the Zone.", "sourceNote": "StalkerNet map/location archive text, pending replacement with exact Anomaly in-game description if provided."}, {"title": "Meadows", "category": "Locations", "value": "Surface location", "base": "Southern travel region", "relations": "Surface map archive entry.", "text": "An open southern travel route with scattered cover, lonely roads and enough quiet to make every sound feel suspicious.", "sourceNote": "StalkerNet map/location archive text, pending replacement with exact Anomaly in-game description if provided."}, {"title": "Great Swamps", "category": "Locations", "value": "Surface location", "base": "Wetland zone", "relations": "Surface map archive entry.", "text": "A wetland maze of reeds, bridges, hidden paths and half-drowned ruins. Movement is slow, sightlines are poor and ambushes come dressed as scenery.", "sourceNote": "StalkerNet map/location archive text, pending replacement with exact Anomaly in-game description if provided."}, {"title": "Darkscape", "category": "Locations", "value": "Surface location", "base": "Remote southern-east territory", "relations": "Surface map archive entry.", "text": "A remote southern-east zone built around long roads, sparse safety and the feeling that help is always one map transition too far away.", "sourceNote": "StalkerNet map/location archive text, pending replacement with exact Anomaly in-game description if provided."}, {"title": "Garbage", "category": "Locations", "value": "Surface location", "base": "Scrapyard region", "relations": "Surface map archive entry.", "text": "Scrapyards, wreckage, ambush lanes, mutant movement and scavenger traffic. A place where useful junk and bad decisions breed in heaps.", "sourceNote": "StalkerNet map/location archive text, pending replacement with exact Anomaly in-game description if provided."}, {"title": "Agroprom", "category": "Locations", "value": "Surface location", "base": "Research and military zone", "relations": "Surface map archive entry.", "text": "Old research grounds with military activity and underground approaches. Agroprom sits at the crossroads of science, force and buried trouble.", "sourceNote": "StalkerNet map/location archive text, pending replacement with exact Anomaly in-game description if provided."}, {"title": "Dark Valley", "category": "Locations", "value": "Surface location", "base": "Industrial danger zone", "relations": "Surface map archive entry.", "text": "Industrial ruins, bandit pressure and dangerous road approaches. A hard-edged region where the factories feel less abandoned than hungry.", "sourceNote": "StalkerNet map/location archive text, pending replacement with exact Anomaly in-game description if provided."}, {"title": "Rostok", "category": "Locations", "value": "Surface location", "base": "Major stalker hub", "relations": "Surface map archive entry.", "text": "A major stalker hub with traders, technicians, jobs and heavy traffic. Rostok is one of the places where the Zone almost pretends to be civilised.", "sourceNote": "StalkerNet map/location archive text, pending replacement with exact Anomaly in-game description if provided."}, {"title": "Wild Territory", "category": "Locations", "value": "Surface location", "base": "Industrial danger ground", "relations": "Surface map archive entry.", "text": "Ruined industrial ground where cover is thin and movement is risky. The Wild Territory rewards speed, caution and knowing when not to cross open ground.", "sourceNote": "StalkerNet map/location archive text, pending replacement with exact Anomaly in-game description if provided."}, {"title": "Yantar", "category": "Locations", "value": "Surface location", "base": "Ecologist research zone", "relations": "Surface map archive entry.", "text": "Ecologist field territory tied to psi danger, scientific work and laboratory rumours. Even the air feels measured, contaminated and nervous.", "sourceNote": "StalkerNet map/location archive text, pending replacement with exact Anomaly in-game description if provided."}, {"title": "Truck Cemetery", "category": "Locations", "value": "Surface location", "base": "Vehicle graveyard", "relations": "Surface map archive entry.", "text": "A graveyard of vehicles, wreckage, anomalies and bad sightlines. The place looks still until something moves between the rust.", "sourceNote": "StalkerNet map/location archive text, pending replacement with exact Anomaly in-game description if provided."}, {"title": "Army Warehouses", "category": "Locations", "value": "Surface location", "base": "Faction staging ground", "relations": "Surface map archive entry.", "text": "Faction routes, patrol pressure and valuable staging ground. Army Warehouses is a contested region where faction politics often speak through rifles.", "sourceNote": "StalkerNet map/location archive text, pending replacement with exact Anomaly in-game description if provided."}, {"title": "Dead City", "category": "Locations", "value": "Surface location", "base": "Abandoned urban zone", "relations": "Surface map archive entry.", "text": "Abandoned urban blocks, mercenary movement and silent windows. Every street feels watched because it probably is.", "sourceNote": "StalkerNet map/location archive text, pending replacement with exact Anomaly in-game description if provided."}, {"title": "Red Forest", "category": "Locations", "value": "Surface location", "base": "Northern hostile woodland", "relations": "Surface map archive entry.", "text": "Dense, hostile woodland with high anomaly and mutant risk. The Red Forest is the sort of place that makes a compass feel optimistic.", "sourceNote": "StalkerNet map/location archive text, pending replacement with exact Anomaly in-game description if provided."}, {"title": "Radar", "category": "Locations", "value": "Surface location", "base": "Psi-threat northern route", "relations": "Surface map archive entry.", "text": "A high-risk northern route dominated by old military structures and psi threats. Radar is less a road and more a warning stretched across the map.", "sourceNote": "StalkerNet map/location archive text, pending replacement with exact Anomaly in-game description if provided."}, {"title": "Limansk", "category": "Locations", "value": "Surface location", "base": "Broken city routes", "relations": "Surface map archive entry.", "text": "Broken city routes, contested streets and hard urban movement. Limansk turns every intersection into a small tactical argument.", "sourceNote": "StalkerNet map/location archive text, pending replacement with exact Anomaly in-game description if provided."}, {"title": "Deserted Hospital", "category": "Locations", "value": "Surface location", "base": "Ruined medical complex", "relations": "Surface map archive entry.", "text": "A ruined medical complex with tight corridors, grim echoes and the kind of quiet that makes reloads sound too loud.", "sourceNote": "StalkerNet map/location archive text, pending replacement with exact Anomaly in-game description if provided."}, {"title": "Jupiter", "category": "Locations", "value": "Surface location", "base": "Factory and salvage zone", "relations": "Surface map archive entry.", "text": "A factory zone with tunnels, salvage routes and northern contracts. Jupiter mixes industrial sprawl with the promise of work and the threat of what still works.", "sourceNote": "StalkerNet map/location archive text, pending replacement with exact Anomaly in-game description if provided."}, {"title": "Zaton", "category": "Locations", "value": "Surface location", "base": "Swamps and wrecks", "relations": "Surface map archive entry.", "text": "Swamps, wrecks, stalker routes and scattered survivor camps. Zaton is wet, open, deceptive and never as empty as it first appears.", "sourceNote": "StalkerNet map/location archive text, pending replacement with exact Anomaly in-game description if provided."}, {"title": "Outskirts", "category": "Locations", "value": "Surface location", "base": "Late-zone urban fringe", "relations": "Surface map archive entry.", "text": "Late-zone urban fringe with heavy danger and valuable approaches. The Outskirts sit near the heart of things, where every route feels expensive.", "sourceNote": "StalkerNet map/location archive text, pending replacement with exact Anomaly in-game description if provided."}, {"title": "Pripyat", "category": "Locations", "value": "Surface location", "base": "High-risk urban ruin", "relations": "Surface map archive entry.", "text": "Urban ruin of high-value salvage, heavy resistance and bad omens. Pripyat is a city-shaped grave with working doors.", "sourceNote": "StalkerNet map/location archive text, pending replacement with exact Anomaly in-game description if provided."}, {"title": "Chernobyl NPP", "category": "Locations", "value": "Surface location", "base": "Heart of the Zone", "relations": "Surface map archive entry.", "text": "The heart of the Zone, where every road feels watched. The Chernobyl Nuclear Power Plant is less a destination than the centre of the wound.", "sourceNote": "StalkerNet map/location archive text, pending replacement with exact Anomaly in-game description if provided."}, {"title": "Generators", "category": "Locations", "value": "Surface location", "base": "Northern extreme zone", "relations": "Surface map archive entry.", "text": "Northern extreme zone with severe threats and endgame-grade danger. Generators is where the map stops being a map and becomes a dare.", "sourceNote": "StalkerNet map/location archive text, pending replacement with exact Anomaly in-game description if provided."}];
...
function getFullArchiveEntries() {
  ...
  const artifacts = (typeof ARTIFACT_ARCHIVE_ENTRIES !== "undefined" && Array.isArray(ARTIFACT_ARCHIVE_ENTRIES)) ? ARTIFACT_ARCHIVE_ENTRIES : [];
  return [...getBaseFactionArchiveEntries(), ...mutants, ...anomalies, ...artifacts, ...LOCATION_ARCHIVE_ENTRIES];
}

function archiveCategories() {
  return ["All", "Factions", "Mutants", "Anomalies", "Artifacts", "Locations"];
}
...
function bindFactionArchiveSearch() {
  const searchInput = document.getElementById("loreSearch") || document.getElementById("archiveSearch");
  if (searchInput && !searchInput.dataset.archiveV32Bound) {
    searchInput.dataset.archiveV32Bound = "true";
