const STORAGE_KEY = "stalkernet_pda_v30_archive_anomalies";
...
// v3.0 Archive expansion: Factions + Mutants + Anomalies
const ANOMALY_ARCHIVE_ENTRIES = [{"title": "Vortex", "category": "Anomalies", "value": "Gravitational anomaly", "base": "Listed in Shadow of Chernobyl anomalies", "relations": "Usually detected safely with bolts.", "text": "Vortex is a gravitational anomaly from the S.T.A.L.K.E.R. series. It distorts the space around it and can drag or tear apart anything that enters its active area. It belongs to the family of anomalies that punish careless movement through invisible force rather than obvious flame, acid or electricity.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Burner", "category": "Anomalies", "value": "Thermal anomaly", "base": "Listed in Shadow of Chernobyl anomalies", "relations": "Avoid direct contact; bolts can trigger its burst.", "text": "Burner is a thermal anomaly. It releases sudden bursts of intense heat, burning anything that wanders into its range. It is one of the Zone’s classic elemental hazards: often quiet until disturbed, then instantly lethal to the careless stalker.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Fruit Punch", "category": "Anomalies", "value": "Chemical / corrosive anomaly", "base": "Listed in Shadow of Chernobyl anomalies", "relations": "Avoid stepping into it. Often visually distinct due to its green corrosive appearance.", "text": "Fruit Punch is a corrosive chemical anomaly. It appears as a dangerous acidic pool or spill-like anomaly capable of damaging living tissue and equipment. It is commonly associated with closed, underground or industrial areas where poor visibility and cramped movement make it harder to avoid.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Electro", "category": "Anomalies", "value": "Electrical anomaly", "base": "Listed in Shadow of Chernobyl anomalies", "relations": "Bolts can trigger discharge before crossing.", "text": "Electro is an electrical anomaly that discharges violently when disturbed. It can be detected by its crackling energy and the sudden burst that follows contact with objects, creatures or bolts. The danger is immediate and punishing, especially in wet or confined terrain.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Springboard", "category": "Anomalies", "value": "Gravitational anomaly", "base": "Listed in Shadow of Chernobyl anomalies", "relations": "Often tested with bolts before movement.", "text": "Springboard is a gravitational anomaly that violently throws or crushes anything that enters its active field. It is one of the Zone’s common invisible traps, making bolt use and careful observation essential for travel through anomaly fields.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Whirligig", "category": "Anomalies", "value": "Gravitational anomaly", "base": "Listed in Shadow of Chernobyl anomalies", "relations": "Avoid the centre of distortion; use bolts to locate it.", "text": "Whirligig is a gravitational anomaly known for spinning, pulling or tearing victims caught in its field. It is closely associated with distorted air and violent spatial force, turning an apparently empty patch of ground into a lethal trap.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Burnt Fuzz", "category": "Anomalies", "value": "Chemical / contact anomaly", "base": "Listed in Shadow of Chernobyl anomalies", "relations": "Dangerous on contact, especially when growing on surfaces.", "text": "Burnt Fuzz is an unusual contact anomaly often associated with strange growth on surfaces such as metal, trees or pipes. It is less explosive than many anomalies, but still hazardous if touched or brushed against in cluttered environments.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Radiation", "category": "Anomalies", "value": "Radiological hazard", "base": "Listed in Shadow of Chernobyl anomalies", "relations": "Requires protection, medication or avoidance.", "text": "Radiation is one of the Zone’s most persistent hazards. Unlike obvious anomalies, it can poison an area quietly and punish stalkers who stay too long without protection, medicine or a detector warning. It is less dramatic than a Vortex, but often more patient.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Comet", "category": "Anomalies", "value": "Thermal moving anomaly", "base": "Listed in Shadow of Chernobyl anomalies", "relations": "Avoid its path and movement pattern.", "text": "Comet is a fire-associated moving anomaly from the S.T.A.L.K.E.R. series. Unlike static hazards, moving anomalies create danger through timing and pathing, forcing stalkers to watch the area rather than simply mark a single safe route.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Fault", "category": "Anomalies", "value": "Clear Sky anomaly", "base": "Listed as new in Clear Sky", "relations": "Series anomaly entry.", "text": "Fault is listed among anomalies introduced in S.T.A.L.K.E.R.: Clear Sky. This archive keeps its description conservative until it can be verified directly against Anomaly or in-game PDA data.", "sourceNote": "General S.T.A.L.K.E.R. anomaly list, pending replacement with Anomaly in-game description."}, {"title": "Space Anomaly", "category": "Anomalies", "value": "Spatial anomaly", "base": "Listed as new in Clear Sky", "relations": "Series anomaly entry.", "text": "Space Anomaly is listed among anomalies introduced in Clear Sky. Spatial anomalies represent some of the Zone’s strangest behaviour, where distance and position stop behaving normally. This entry is marked for later verification against Anomaly descriptions.", "sourceNote": "General S.T.A.L.K.E.R. anomaly list, pending replacement with Anomaly in-game description."}, {"title": "Symbiont", "category": "Anomalies", "value": "Clear Sky anomaly", "base": "Listed as new in Clear Sky", "relations": "Series anomaly entry.", "text": "Symbiont is listed as an anomaly introduced in S.T.A.L.K.E.R.: Clear Sky. The archive entry is intentionally restrained for now, ready to be replaced with exact Anomaly PDA text if you provide screenshots later.", "sourceNote": "General S.T.A.L.K.E.R. anomaly list, pending replacement with Anomaly in-game description."}, {"title": "Gas", "category": "Anomalies", "value": "Chemical anomaly", "base": "Listed as new in Clear Sky", "relations": "Avoid contaminated cloud or field.", "text": "Gas is a chemical anomaly associated with toxic or corrosive airborne danger rather than a solid pool. It threatens stalkers through exposure, making protection and route choice more important than simply dodging a visible centre point.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Emission", "category": "Anomalies", "value": "Zone-wide phenomenon", "base": "Listed as new in Clear Sky", "relations": "Shelter required.", "text": "Emission is a massive Zone phenomenon rather than a small local anomaly. During an emission, the Zone becomes lethally unstable and stalkers must find shelter quickly. It is one of the clearest reminders that the Zone itself can become the enemy.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Gas Cloud", "category": "Anomalies", "value": "Chemical anomaly", "base": "Listed as new in Call of Pripyat", "relations": "Avoid toxic moving cloud.", "text": "Gas Cloud is listed among anomalies introduced in Call of Pripyat. It represents an airborne chemical hazard, dangerous because its boundaries and safe passage may be less obvious than a static anomaly field.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Tesla", "category": "Anomalies", "value": "Electrical anomaly", "base": "Listed as new in Call of Pripyat", "relations": "Avoid contact with moving electrical field.", "text": "Tesla is an electrical anomaly introduced in Call of Pripyat. Unlike a simple static Electro field, Tesla is associated with a moving electrical hazard, making timing, distance and observation especially important.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}];
...
function getFullArchiveEntries() {
  ...
  return [...getBaseFactionArchiveEntries(), ...mutants, ...ANOMALY_ARCHIVE_ENTRIES];
}
...
function bindFactionArchiveSearch() {
  const searchInput = document.getElementById("loreSearch") || document.getElementById("archiveSearch");
  if (searchInput && !searchInput.dataset.archiveV30Bound) {
    searchInput.dataset.archiveV30Bound = "true";
