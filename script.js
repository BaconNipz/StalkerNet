const STORAGE_KEY = "stalkernet_pda_v301_archive_repair";
...
// v3.0.1 Archive repair: one combined source for Factions + Mutants + Anomalies
const MUTANT_ARCHIVE_ENTRIES = [{"title": "Blind Dog", "category": "Mutants", "value": "Animal / Animal-Like Creature", "base": "Common mutant canine", "relations": "Series lore description, pending Anomaly PDA verification.", "text": "Blind Dogs are mutated canine pack hunters. They have lost normal sight but compensate with strong senses and group behaviour. Alone they are usually manageable, but packs can surround a stalker quickly, forcing movement mistakes and draining ammunition. They are one of the Zone’s most familiar early threats.", "sourceNote": "General S.T.A.L.K.E.R. mutant lore, pending replacement with Anomaly in-game description."}, {"title": "Boar", "category": "Mutants", "value": "Animal / Animal-Like Creature", "base": "Mutated wild boar", "relations": "Series lore description, pending Anomaly PDA verification.", "text": "Boars are heavily mutated animals known for charging directly at threats. Their danger comes less from cunning and more from mass, speed and aggression. They can close distance fast, punish poor positioning and make open ground unsafe when encountered in groups.", "sourceNote": "General S.T.A.L.K.E.R. mutant lore, pending replacement with Anomaly in-game description."}, {"title": "Cat", "category": "Mutants", "value": "Animal / Animal-Like Creature", "base": "Mutated feline predator", "relations": "Series lore description, pending Anomaly PDA verification.", "text": "Cats are fast, agile mutant predators associated with sudden attacks and unsettling vocalisations. They are smaller than many Zone creatures, but their speed and tendency to close the gap quickly makes them dangerous in broken terrain, grass, ruins and poor visibility.", "sourceNote": "General S.T.A.L.K.E.R. mutant lore, pending replacement with Anomaly in-game description."}, {"title": "Chimera", "category": "Mutants", "value": "Animal / Animal-Like Creature", "base": "Large two-headed predator", "relations": "Series lore description, pending Anomaly PDA verification.", "text": "Chimeras are among the most dangerous predators in the Zone. They are large, muscular, extremely aggressive and capable of covering distance with powerful leaps. Their two-headed appearance and sudden pouncing attacks make them terrifying in close quarters, especially at night or in cluttered terrain.", "sourceNote": "General S.T.A.L.K.E.R. mutant lore, pending replacement with Anomaly in-game description."}, {"title": "Crow", "category": "Mutants", "value": "Animal / Animal-Like Creature", "base": "Zone bird life", "relations": "Series lore description, pending Anomaly PDA verification.", "text": "Crows are part of the Zone’s animal life and are often seen circling ruins, fields and dead ground. Compared with most mutants, they are not a direct battlefield threat, but their presence helps sell the feeling of an ecosystem that has learned to feed on disaster.", "sourceNote": "General S.T.A.L.K.E.R. mutant lore, pending replacement with Anomaly in-game description."}, {"title": "Flesh", "category": "Mutants", "value": "Animal / Animal-Like Creature", "base": "Mutated pig", "relations": "Series lore description, pending Anomaly PDA verification.", "text": "Fleshes are heavily mutated pigs, widely encountered across the Zone. They are generally less aggressive than many other mutants and may avoid stalkers unless provoked, but they can still fight back with dangerous close-range attacks. They are often found near other animal mutants such as boars.", "sourceNote": "General S.T.A.L.K.E.R. mutant lore, pending replacement with Anomaly in-game description."}, {"title": "Lurker", "category": "Mutants", "value": "Animal / Animal-Like Creature", "base": "Ambush predator", "relations": "Series lore description, pending Anomaly PDA verification.", "text": "Lurkers are fast ambush predators. They rely on speed, sudden movement and broken sightlines to pressure stalkers. Their danger comes from how quickly a quiet area can become a close-range fight, particularly in ruins, forests and uneven ground.", "sourceNote": "General S.T.A.L.K.E.R. mutant lore, pending replacement with Anomaly in-game description."}, {"title": "Pseudodog", "category": "Mutants", "value": "Animal / Animal-Like Creature", "base": "Mutated canine predator", "relations": "Series lore description, pending Anomaly PDA verification.", "text": "Pseudodogs resemble large mutated canines and are more dangerous than ordinary Blind Dogs. They are stronger, more aggressive and harder to put down. Stalkers often learn to treat their howls as a warning that the pack may include something worse than dogs.", "sourceNote": "General S.T.A.L.K.E.R. mutant lore, pending replacement with Anomaly in-game description."}, {"title": "Pseudogiant", "category": "Mutants", "value": "Animal / Animal-Like Creature", "base": "Massive heavy mutant", "relations": "Series lore description, pending Anomaly PDA verification.", "text": "Pseudogiants are enormous mutants with tremendous durability and destructive power. They are slow compared with leaping predators, but their bulk, shock attacks and ability to absorb punishment make them one of the most dangerous encounters a stalker can face without heavy weapons or room to retreat.", "sourceNote": "General S.T.A.L.K.E.R. mutant lore, pending replacement with Anomaly in-game description."}, {"title": "Psydog", "category": "Mutants", "value": "Animal / Animal-Like Creature", "base": "Psychic canine mutant", "relations": "Series lore description, pending Anomaly PDA verification.", "text": "Psydogs are psychic variants of mutant dogs. Their danger comes from confusion and misdirection, often creating phantom threats or forcing stalkers to waste time and ammunition while the real creature remains mobile. They are especially dangerous when panic breaks target discipline.", "sourceNote": "General S.T.A.L.K.E.R. mutant lore, pending replacement with Anomaly in-game description."}, {"title": "Rat(mod)", "category": "Mutants", "value": "Animal / Animal-Like Creature", "base": "Small mutant animal", "relations": "Series/mod description, pending Anomaly PDA verification.", "text": "Rats are small mutant animals used in some builds and mods. Individually they are minor threats, but small creatures in the Zone are rarely harmless when encountered in numbers or in cramped spaces where movement is restricted.", "sourceNote": "General S.T.A.L.K.E.R. mutant lore, pending replacement with Anomaly in-game description."}, {"title": "Tushkano", "category": "Mutants", "value": "Animal / Animal-Like Creature", "base": "Small pack mutant", "relations": "Series lore description, pending Anomaly PDA verification.", "text": "Tushkanos are small, fast mutant creatures that attack in groups. Their size makes them easy to underestimate, but they can swarm wounded or distracted stalkers and become dangerous in tunnels, basements and tight industrial spaces.", "sourceNote": "General S.T.A.L.K.E.R. mutant lore, pending replacement with Anomaly in-game description."}, {"title": "Bloodsucker", "category": "Mutants", "value": "Humanoid", "base": "Cloaking humanoid predator", "relations": "Series lore description, pending Anomaly PDA verification.", "text": "Bloodsuckers are infamous humanoid predators capable of near-invisibility. They stalk prey, close in silently and strike with terrifying speed. Their tentacled mouth, ambush behaviour and ability to appear only at the last moment make them one of the Zone’s most feared close-range threats.", "sourceNote": "General S.T.A.L.K.E.R. mutant lore, pending replacement with Anomaly in-game description."}, {"title": "Burer", "category": "Mutants", "value": "Humanoid", "base": "Psychokinetic humanoid mutant", "relations": "Series lore description, pending Anomaly PDA verification.", "text": "Burers are short humanoid mutants with powerful psychokinetic abilities. They can manipulate objects, disrupt weapons and attack from range through supernatural force rather than speed. They are especially dangerous indoors, where loose objects, tight corridors and bad cover turn the environment into a weapon.", "sourceNote": "General S.T.A.L.K.E.R. mutant lore, pending replacement with Anomaly in-game description."}, {"title": "Controller", "category": "Mutants", "value": "Humanoid", "base": "Psychic humanoid mutant", "relations": "Series lore description, pending Anomaly PDA verification.", "text": "Controllers are humanoid mutants with powerful psychic influence. They can attack the mind directly, disorienting or overwhelming stalkers before a normal firefight even begins. Their danger is not only physical: meeting one unprepared can mean losing control of the situation before seeing the enemy clearly.", "sourceNote": "General S.T.A.L.K.E.R. mutant lore, pending replacement with Anomaly in-game description."}, {"title": "Fracture", "category": "Mutants", "value": "Humanoid", "base": "Deformed humanoid mutant", "relations": "Series lore description, pending Anomaly PDA verification.", "text": "Fractures are deformed humanoid mutants. Their twisted bodies and erratic movement make them disturbing encounters, and their threat comes from closing distance in places where a stalker may already be dealing with darkness, debris or other mutants.", "sourceNote": "General S.T.A.L.K.E.R. mutant lore, pending replacement with Anomaly in-game description."}, {"title": "Karlik", "category": "Mutants", "value": "Humanoid", "base": "Small humanoid mutant", "relations": "Series/mod description, pending Anomaly PDA verification.", "text": "Karliks are small humanoid mutants associated with psychic or abnormal behaviour in wider Zone lore and mods. They are not physically imposing, but small humanoid mutants are dangerous because they are easy to lose in clutter and often appear in places already hostile to visibility and movement.", "sourceNote": "General S.T.A.L.K.E.R. mutant lore, pending replacement with Anomaly in-game description."}, {"title": "Psysucker", "category": "Mutants", "value": "Humanoid", "base": "Psychic bloodsucker variant", "relations": "Anomaly/mod description, pending in-game verification.", "text": "Psysuckers are associated with Anomaly and modded S.T.A.L.K.E.R. content as a psychic variant of the Bloodsucker concept. They combine the fear of a close-range ambusher with psychic pressure, making them dangerous because the stalker must manage both the visible fight and mental interference.", "sourceNote": "General S.T.A.L.K.E.R. mutant lore, pending replacement with Anomaly in-game description."}, {"title": "Snork", "category": "Mutants", "value": "Humanoid", "base": "Mutated human-like leaper", "relations": "Series lore description, pending Anomaly PDA verification.", "text": "Snorks are grotesque humanoid mutants, often associated with former humans twisted into animal-like movement. They attack with sudden leaps, crawling and pouncing in ways that make them hard to track at close range. Their gas-mask-like appearance makes them one of the Zone’s most recognisable horrors.", "sourceNote": "General S.T.A.L.K.E.R. mutant lore, pending replacement with Anomaly in-game description."}, {"title": "Zombie", "category": "Mutants", "value": "Humanoid", "base": "Zombified stalker", "relations": "Series lore description, pending Anomaly PDA verification.", "text": "Zombies are stalkers whose minds have been broken by psi influence, leaving them as hostile, shambling remnants. They may still carry weapons and behave like fragments of their former selves, making them especially grim: not quite mutants in the animal sense, but no longer ordinary humans either.", "sourceNote": "General S.T.A.L.K.E.R. mutant lore, pending replacement with Anomaly in-game description."}, {"title": "Chernobog", "category": "Mutants", "value": "Special / Unknown Mutant", "base": "Special / unknown entry", "relations": "Anomaly special entry, pending in-game verification.", "text": "Chernobog is listed by the Anomaly Wiki under Special / Unknown Mutants. Because this entry is tied closely to Anomaly-specific content, this archive entry is intentionally conservative until an in-game description or direct screenshot can replace it.", "sourceNote": "General S.T.A.L.K.E.R. mutant lore, pending replacement with Anomaly in-game description."}, {"title": "Poltergeist", "category": "Mutants", "value": "Special / Unknown Mutant", "base": "Anomalous invisible entity", "relations": "Series lore description, pending Anomaly PDA verification.", "text": "Poltergeists are anomalous entities associated with invisible or barely visible movement and telekinetic attacks. Instead of charging like animals, they weaponise the environment, throwing objects and forcing stalkers to fight something that is difficult to see, locate and understand.", "sourceNote": "General S.T.A.L.K.E.R. mutant lore, pending replacement with Anomaly in-game description."}, {"title": "Pseudogeist", "category": "Mutants", "value": "Special / Unknown Mutant", "base": "Special / unknown poltergeist-like entry", "relations": "Anomaly/mod entry, pending in-game verification.", "text": "Pseudogeist is listed by the Anomaly Wiki under Special / Unknown Mutants. The name suggests a poltergeist-like threat or variant, but this archive keeps the description restrained until a direct Anomaly PDA entry or screenshot confirms the details.", "sourceNote": "General S.T.A.L.K.E.R. mutant lore, pending replacement with Anomaly in-game description."}, {"title": "Pyrogeist", "category": "Mutants", "value": "Special / Unknown Mutant", "base": "Fire-associated poltergeist variant", "relations": "Series/mod description, pending in-game verification.", "text": "Pyrogeists are fire-associated poltergeist variants in wider Zone lore and modded content. They are treated as special or unknown mutants and are dangerous because their threat is tied to anomaly-like effects rather than ordinary claws, teeth or bullets.", "sourceNote": "General S.T.A.L.K.E.R. mutant lore, pending replacement with Anomaly in-game description."}];
const ANOMALY_ARCHIVE_ENTRIES = [{"title": "Vortex", "category": "Anomalies", "value": "Gravitational anomaly", "base": "Classic gravitational anomaly", "relations": "Usually detected safely with bolts.", "text": "Vortex is a gravitational anomaly from the S.T.A.L.K.E.R. series. It distorts the space around it and can drag or tear apart anything that enters its active area.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Burner", "category": "Anomalies", "value": "Thermal anomaly", "base": "Classic thermal anomaly", "relations": "Avoid direct contact; bolts can trigger its burst.", "text": "Burner releases sudden bursts of intense heat, burning anything that wanders into its range. It is one of the Zone’s classic elemental hazards.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Fruit Punch", "category": "Anomalies", "value": "Chemical / corrosive anomaly", "base": "Classic chemical anomaly", "relations": "Avoid stepping into it. Often visually green or corrosive.", "text": "Fruit Punch is a corrosive chemical anomaly, usually appearing as a dangerous acidic pool or spill-like hazard capable of damaging living tissue and equipment.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Electro", "category": "Anomalies", "value": "Electrical anomaly", "base": "Classic electrical anomaly", "relations": "Bolts can trigger discharge before crossing.", "text": "Electro discharges violently when disturbed. It can be recognised by crackling energy and sudden electrical bursts.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Springboard", "category": "Anomalies", "value": "Gravitational anomaly", "base": "Classic gravitational anomaly", "relations": "Often tested with bolts before movement.", "text": "Springboard is a gravitational anomaly that violently throws or crushes anything entering its active field.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Whirligig", "category": "Anomalies", "value": "Gravitational anomaly", "base": "Classic gravitational anomaly", "relations": "Avoid the centre of distortion; use bolts to locate it.", "text": "Whirligig is a gravitational anomaly known for spinning, pulling or tearing victims caught in its field.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Burnt Fuzz", "category": "Anomalies", "value": "Chemical / contact anomaly", "base": "Surface/contact anomaly", "relations": "Dangerous on contact, especially on surfaces.", "text": "Burnt Fuzz is an unusual contact anomaly often associated with strange growth on surfaces such as metal, trees or pipes.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Radiation", "category": "Anomalies", "value": "Radiological hazard", "base": "Persistent Zone hazard", "relations": "Requires protection, medication or avoidance.", "text": "Radiation is one of the Zone’s most persistent hazards. It can poison an area quietly and punish stalkers who stay too long without protection, medicine or detector warning.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Comet", "category": "Anomalies", "value": "Thermal moving anomaly", "base": "Moving fire anomaly", "relations": "Avoid its path and movement pattern.", "text": "Comet is a fire-associated moving anomaly. Its danger comes from timing and pathing rather than one static danger point.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Fault", "category": "Anomalies", "value": "Clear Sky anomaly", "base": "Listed as Clear Sky anomaly", "relations": "Pending in-game verification.", "text": "Fault is listed among anomalies introduced in S.T.A.L.K.E.R.: Clear Sky. This archive keeps its description conservative until verified directly against Anomaly or in-game PDA data.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Space Anomaly", "category": "Anomalies", "value": "Spatial anomaly", "base": "Listed as Clear Sky anomaly", "relations": "Pending in-game verification.", "text": "Space Anomaly represents some of the Zone’s strangest behaviour, where distance and position stop behaving normally.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Symbiont", "category": "Anomalies", "value": "Clear Sky anomaly", "base": "Listed as Clear Sky anomaly", "relations": "Pending in-game verification.", "text": "Symbiont is listed as an anomaly introduced in S.T.A.L.K.E.R.: Clear Sky. This entry is marked for later verification.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Gas", "category": "Anomalies", "value": "Chemical anomaly", "base": "Clear Sky chemical anomaly", "relations": "Avoid contaminated cloud or field.", "text": "Gas is a chemical anomaly associated with toxic or corrosive airborne danger rather than a solid pool.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Emission", "category": "Anomalies", "value": "Zone-wide phenomenon", "base": "Zone-wide blowout event", "relations": "Shelter required.", "text": "Emission is a massive Zone phenomenon rather than a small local anomaly. During an emission, the Zone becomes lethally unstable and stalkers must find shelter quickly.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Gas Cloud", "category": "Anomalies", "value": "Chemical anomaly", "base": "Call of Pripyat anomaly", "relations": "Avoid toxic moving cloud.", "text": "Gas Cloud represents an airborne chemical hazard, dangerous because its boundaries and safe passage may be less obvious than a static anomaly field.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}, {"title": "Tesla", "category": "Anomalies", "value": "Electrical anomaly", "base": "Call of Pripyat anomaly", "relations": "Avoid contact with moving electrical field.", "text": "Tesla is an electrical anomaly associated with a moving electrical hazard, making timing, distance and observation especially important.", "sourceNote": "General S.T.A.L.K.E.R. anomaly lore, pending replacement with Anomaly in-game description."}];
...
function getFullArchiveEntries() {
  return [...getBaseFactionArchiveEntries(), ...MUTANT_ARCHIVE_ENTRIES, ...ANOMALY_ARCHIVE_ENTRIES];
}

function archiveCategories() { return ["All", "Factions", "Mutants", "Anomalies"]; }
...
function bindFactionArchiveSearch() {
  const searchInput = document.getElementById("loreSearch") || document.getElementById("archiveSearch");
  if (searchInput && !searchInput.dataset.archiveV301Bound) {
    searchInput.dataset.archiveV301Bound = "true";
